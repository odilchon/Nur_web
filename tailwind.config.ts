  ...
  theme: {
    extend: {
      colors: {
        ...
        // Коралловый — тёплый акцент бренда (из логотипа)
        coral: {
          50: "#FDF0EE",
          100: "#FADAD6",
          200: "#F4ADA4",
      ...
      boxShadow: {
        ...
        coral: "0 18px 44px -18px rgba(222, 82, 70, 0.45)",
      },
      backgroundImage: {
        "nur-glow":
        ...
        // Фирменный градиент логотипа: коралл → фиолетовый → синий
        "nur-brand":
          "linear-gradient(135deg, #DE5246 0%, #9A6FB0 52%, #4A6FB0 100%)",
      },
      keyframes: {
        "fade-up": {
